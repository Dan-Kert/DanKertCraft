...
/**
 * Deprecated compatibility wrapper for legacy code.
 * All methods delegate to the new LogService to keep the codebase working
 * while migration to LogService is performed.
 */
public class LogService {

    public static void debug(String msg) { LogService.debug(msg); }
    public static void debug(String msg, Throwable t) { LogService.debug(msg, t); }
    public static void info(String msg) { LogService.info(msg); }
    public static void info(String msg, Throwable t) { LogService.info(msg, t); }
    public static void warn(String msg) { LogService.warn(msg); }
    public static void warn(String msg, Throwable t) { LogService.warn(msg, t); }
    public static void error(String msg) { LogService.error(msg); }
    public static void error(String msg, Throwable t) { LogService.error(msg, t); }

    public static void enableFileLogging(String path) { LogService.enableFileLogging(path); }
    public static void disableFileLogging() { LogService.disableFileLogging(); }
    public static String getLogFilePath() { return LogService.getLogFilePath(); }
    public static void flushAndClose() { LogService.flushAndClose(); }

    public static void replaceSystemOut(String msg) { LogService.info(msg); }
    public static void replaceSystemErr(String msg) { LogService.error(msg); }

    public static void showLogViewer() { LogService.showLogViewer(); }
}
    ...
    public static void enableFileLogging(String filePath) {
        synchronized (WRITE_LOCK) {
            try {
                ...
                if (!loggerRunning) {
                    loggerRunning = true;
                    logWriterThread = new Thread(LogService::logWriterWorker, "LogWriter-Thread");
            ...
            if (logWriterThread != null && logWriterThread.isAlive()) {
                try {
                    ...
                    if (logWriterThread.isAlive()) {
                        LogService.warn("⚠️ LogWriter не завершился за 5 сек, принудительное завершение");
